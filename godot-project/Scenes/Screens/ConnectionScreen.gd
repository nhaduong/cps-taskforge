...
func _on_create_account_btn_pressed():
    email = $TabContainer/CreateAccount/GridContainer/Email.text.strip_edges()
    password = $TabContainer/CreateAccount/GridContainer/Password.text.strip_edges()
    
    var username = $TabContainer/CreateAccount/GridContainer/Username.text.strip_edges()
    var save_credentials = $TabContainer/CreateAccount/GridContainer/SaveCheckbox.button_pressed
